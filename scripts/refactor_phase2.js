...
const pJs = [
    ...
    { from: `.style.display = 'none'`, to: `.classList.add('hidden')` },
    { from: `.style.opacity = '0.6'`, to: `.classList.add('opacity-60')` },
    { from: `.style.opacity = '1'`, to: `.classList.remove('opacity-60', 'opacity-50')` },
    { from: `.style.opacity = '0.5'`, to: `.classList.add('opacity-50')` },
    { from: `.style.pointerEvents = 'none'`, to: `.classList.add('no-pointer')` },
    { from: `.style.pointerEvents = 'auto'`, to: `.classList.remove('no-pointer')` },
    { from: `.style.display = 'table-footer-group'`, to: `.classList.add('table-footer'); .classList.remove('hidden');` },
    { from: `.style.display = 'table-cell'`, to: `.classList.add('table-cell'); .classList.remove('hidden');` },
    ...
    { from: `style="color: #b37400;"`, to: `class="text-warning"` }, // approximated color
    { from: `style="color: #0056b3;"`, to: `class="text-primary"` }, // approximated color
    { from: `style="border-bottom: 2px solid #eee;"`, to: `class="border-bottom-dashed"` }, // approximate or use class
...
const rJs = [
    ...
    { from: `.style.display = 'inline-block'`, to: `.classList.remove('hidden')` },
    { from: `.style.background = 'var(--border)'`, to: `.classList.add('bg-border'); .classList.remove('bg-warning', 'bg-success')` },
    { from: `.style.color = 'var(--text-main)'`, to: `.classList.add('text-main'); .classList.remove('text-warning', 'text-success')` },
    { from: `.style.background = 'var(--warning)'`, to: `.classList.add('bg-warning')` },
    { from: `.style.color = 'var(--warning-text)'`, to: `.classList.add('text-warning')` },
    { from: `.style.opacity = '0.5'`, to: `.classList.add('opacity-50')` },
    { from: `.style.opacity = '1'`, to: `.classList.remove('opacity-50')` },
    { from: `style="padding: 12px 15px;"`, to: `class="px-15 py-12"` },
    { from: `style="text-align: right; padding: 12px 15px;"`, to: `class="text-right px-15 py-12"` },
    ...
    { from: `style="width: 15px; height: 15px;"`, to: `class="w-16 h-16"` }, // approximated
...
// Missing global custom utilities:
const globalCss = `
...
`;
fs.appendFileSync('public/css/modules.css', globalCss);

console.log('Phase 2 safe replace done.');
