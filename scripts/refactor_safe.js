...
const ejsReplacements = [
    { from: `class="btn btn-outline" style="margin-right: 10px; display: none;"`, to: `class="btn btn-outline mr-10 hidden"` },
    ...
    { from: `class="dash-drill-container" style="overflow: hidden; width: 100%; margin-bottom: 20px; border-radius: 12px; transition: all 0.3s ease;"`, to: `class="dash-drill-container dash-drill-container-wrap"` },
    { from: `class="dashboard-tabs-content collapsed-panel" style="display: flex; width: 300%; transition: transform 0.4s ease-in-out, max-height 0.4s ease-in-out, opacity 0.4s ease-in-out; align-items: flex-start; transform: translateX(0%); overflow: hidden;"`, to: `class="dashboard-tabs-content collapsed-panel" style="transform: translateX(0%);"` },
    { from: `class="tab-panel" style="width: 33.333%; padding-right: 20px; box-sizing: border-box;"`, to: `class="tab-panel dash-tab-panel dash-tab-panel-1"` },
    { from: `class="tab-panel" style="width: 33.333%; padding-right: 10px; padding-left: 10px; box-sizing: border-box;"`, to: `class="tab-panel dash-tab-panel dash-tab-panel-2"` },
    { from: `class="tab-panel" style="width: 33.333%; padding-left: 20px; box-sizing: border-box;"`, to: `class="tab-panel dash-tab-panel dash-tab-panel-3"` },
    { from: `class="font-11 text-muted font-bold" style="text-transform: uppercase;"`, to: `class="font-11 text-muted font-bold dash-financial-header"` },
    { from: `class="font-11 text-info p-5" style="background: var(--info-bg); border-radius: 4px;"`, to: `class="font-11 text-info p-5 dash-info-badge"` },
    { from: `class="font-24 text-warning" style="font-weight: 900; line-height: 1;"`, to: `class="font-24 text-warning dash-heavy-amount"` },
];
...
const jsReplacements = [
    ...
    { from: `container.style.display = 'flex'`, to: `container.classList.remove('hidden')` },
    { from: `style="padding: 20px; text-align: center;"`, to: `class="p-20 text-center"` },
    { from: `class="btn btn-outline p-5 font-12" style="height: 26px;"`, to: `class="btn btn-outline p-5 font-12 h-26"` },
    // Notice the specific quotes properly escaped below to match exactly what is in dashboard.js
    { 
    ...
    { from: `class="input-modern" style="padding: 4px 6px; font-size: 13px; border-radius: 6px; height: 32px; width: 130px;"`, to: `class="input-modern dash-period-input dash-period-input-date"` },
    { from: `class="input-modern" style="padding: 4px 6px; font-size: 13px; border-radius: 6px; height: 32px;"`, to: `class="input-modern dash-period-input"` },
    ...
    { from: `style="font-size: 14px; padding: 10px;"`, to: `class="font-14 p-10"` },
    { from: `style="font-size: 14px; padding: 10px; font-weight: 600;"`, to: `class="font-14 p-10 font-600"` },
