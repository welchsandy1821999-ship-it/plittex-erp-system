...
# Prices for 40mm and 60mm Classico/Uriko
# (Grey, Color)
PRICES_MANUAL = {
...
def process():
    ...
    # 3. Match and Build Table
    final_rows = []
    
    # Fallback price logic for known patterns
    fallbacks = {
    ...
    for name, qty in inventory.items():
        ...
        # Priority 1: Manual Mapping (Classico/Uriko)
    ...
    # Format Markdown
    md = "# Сводная таблица ревизии склада (Март 2026)\n\n"
    ...
    with open('/tmp/final_revision_table_v2.md', 'w', encoding='utf-8') as f:
        f.write(md)
