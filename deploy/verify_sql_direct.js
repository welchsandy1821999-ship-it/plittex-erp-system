#!/usr/bin/env node
// verify_sql_direct.js — проверка нового SQL расчёта напрямую в БД
...
conn.on('ready', async () => {
    console.log('=== НОВЫЙ РАСЧЁТ БАЛАНСОВ (SQL) ===\n');

    for (const monthStr of ['2026-03', '2026-04', '2026-05', '2026-06']) {
