...
const files = [
    ...
    { local: 'routes/sales.js', remote: '/root/plittex-erp/routes/sales.js' },
    { local: 'routes/inventory.js', remote: '/root/plittex-erp/routes/inventory.js' },
    { local: 'routes/production.js', remote: '/root/plittex-erp/routes/production.js' },
    { local: 'routes/reports.js', remote: '/root/plittex-erp/routes/reports.js' },
    { local: 'routes/docs.js', remote: '/root/plittex-erp/routes/docs.js' },
    { local: 'routes/admin.js', remote: '/root/plittex-erp/routes/admin.js' },
    { local: 'utils/packagingMaterial.js', remote: '/root/plittex-erp/utils/packagingMaterial.js' },
